...
Desired_Angular_velocity      = '_C_1_0_0'
...
while flapper.step(timestep) != -1:
    ...
    # print('vel_FreeFlow',vel_FreeFlow)
    tail_bac.RequestVelocities(vel_FreeFlow + Flapping_wing_induced_flow_Tail, tail_velVec[0:3],\
                                          tail_velVec[3:6],0)                                     
    # TheFlapper_velVec = TheFlapper.getVelocity()
    ...
    tail   .addForceWithOffset([tail_drag[0]* JUSTFOTAILRDEBUG,tail_drag[1]* JUSTFOTAILRDEBUG,tail_drag[2]* JUSTFOTAILRDEBUG] ,(tail_t_shift_raw ) .tolist() ,False)
    ...
    tail   .addForceWithOffset([tail_lift[0] * JUSTFOTAILRDEBUG,tail_lift[1] * JUSTFOTAILRDEBUG,tail_lift[2] * JUSTFOTAILRDEBUG] ,(tail_t_shift_raw ) .tolist(),False)
